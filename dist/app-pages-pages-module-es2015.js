...
class EventTargetInterruptSource extends InterruptSource {
    ...
    constructor(target, events, options) {
         ...
         * @return {?}
         */
        eventName => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEvent"])(target, eventName, opts)));
        this.eventSrc = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["merge"])(...fromEvents);
        this.eventSrc = this.eventSrc.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])((/**
         * @param {?} innerArgs
         * @return {?}
         */
        innerArgs => !this.filterEvent(innerArgs))));
        if (this.throttleDelay > 0) {
            this.eventSrc = this.eventSrc.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["throttleTime"])(this.throttleDelay));
        }
        /** @type {?} */
        const handler = (/**
         * @param {?} innerArgs
 ...
 */
class Keepalive extends _ng_idle_core__WEBPACK_IMPORTED_MODULE_2__["KeepaliveSvc"] {
    /*
    ...
    constructor(http, zone) {
        ...
        /*
           ...
           */
        this.onPing = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        /*
           * An event emitted when the service has pinged an HTTP endpoint and received a response.
           */
        this.onPingResponse = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    /*
    ...
    request(url) {
        if (typeof url === 'string') {
            this.pingRequest = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpRequest"]('GET', url);
        }
        else if (url instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpRequest"]) {
...
class NgIdleKeepaliveModule {
    ...
    static forRoot() {
        return {
            ...
            providers: [Keepalive, { provide: _ng_idle_core__WEBPACK_IMPORTED_MODULE_2__["KeepaliveSvc"], useExisting: Keepalive }]
        };
    }
}
NgIdleKeepaliveModule.decorators = [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"], args: [{ imports: [_ng_idle_core__WEBPACK_IMPORTED_MODULE_2__["NgIdleModule"].forRoot()] },] }
];
...
let RoleGaurdService = class RoleGaurdService {
...
let PagesComponent = class PagesComponent {
    constructor(idle, route, apiService, iconLibraries) {
        this.idle = idle;
        this.route = route;
    ...
    logoutPostApi() {
        ...
        this.apiService.postData(this.apiService.logoutApi, params).subscribe((response) => {
            if (response) {
                sessionStorage.clear();
                localStorage.clear();
...
/* harmony import */ var _ng_idle_keepalive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ng-idle/keepalive */ "./node_modules/@ng-idle/keepalive/fesm2015/ng-idle-keepalive.js");
...
const routes = [{
        ...
        children: [
            ...
            {
                path: 'reports-admin',
                loadChildren: () => Promise.all(/*! import() | pages-wt-admin-reports-admin-reports-admin-module */[__webpack_require__.e("default~pages-wt-admin-clients-clients-module~pages-wt-admin-reports-admin-reports-admin-module~page~8b24f7b3"), __webpack_require__.e("default~pages-wt-admin-clients-clients-module~pages-wt-admin-reports-admin-reports-admin-module"), __webpack_require__.e("pages-wt-admin-reports-admin-reports-admin-module")]).then(__webpack_require__.bind(null, /*! ../pages/wt-admin/reports-admin/reports-admin.module */ "./src/app/pages/wt-admin/reports-admin/reports-admin.module.ts"))
            ...
            {
                path: 'settings',
                loadChildren: () => __webpack_require__.e(/*! import() | pages-wt-admin-settings-settings-module */ "pages-wt-admin-settings-settings-module").then(__webpack_require__.bind(null, /*! ../pages/wt-admin/settings/settings.module */ "./src/app/pages/wt-admin/settings/settings.module.ts"))
...
//# sourceMappingURL=app-pages-pages-module-es2015.js.map